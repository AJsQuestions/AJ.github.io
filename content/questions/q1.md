---
title: "ML Trading Bot in a 100 lines of code: Part 1" 
date: 2024-01-04
url: /q1
...
#### 2.1 Adding Features
With OLHCV data now pulled, we add all possible trechnical indicators from the library TA-lib using their python wrapper. Technical Indicators are derived from market data and serve as features to predict price movements.
...
us_etfs = pd.read_csv("vol_wtd_etf_universe2.csv", usecols=[1])
